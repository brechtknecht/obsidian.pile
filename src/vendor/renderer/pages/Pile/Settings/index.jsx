...
export default function Settings() {
  ...
  return (
    <Dialog.Root>
      ...
      {/* Obsidian port: #dialog lives inside the shadow root, invisible to
          document.getElementById; portal to the in-shadow app root instead. */}
      <Dialog.Portal container={window.__PILE_PORTAL__ ?? document.body}>
