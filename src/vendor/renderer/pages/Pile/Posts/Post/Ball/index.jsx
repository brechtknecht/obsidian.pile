...
const Ball = ({
  ...
  return (
    <DropdownMenu.Root modal={false}>
      ...
      {/* Obsidian port: default portal target is document.body, which sits
          outside our shadow root and loses all styling. */}
      <DropdownMenu.Portal container={window.__PILE_PORTAL__ ?? document.body}>
